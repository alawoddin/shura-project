                        ...
                        <div class="nk-header-wrap">
                            <div class="nk-header-logo ms-n1">
                                ...
                                <a href="index.html" class="logo-link">
                                    <div class="logo-wrap">
                                        <img class="logo-img logo-light" src="{{ asset('backend/images/logo.png') }}" srcset="images/logo2x.png" alt="">
                                        <img class="logo-img logo-dark" src="{{asset('backend/images/logo-dark.png')}}" srcset="images/logo-dark2x.png" alt="">
                                        <img class="logo-img logo-icon" src="{{asset('backend/images/logo-icon.png')}}" srcset="images/logo-icon2x.png" alt="">
                                    </div>
                                </a>
                            </div>
